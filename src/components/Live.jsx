...
import sport from "../images/nba.jpg";
import news from "../images/news.jpg";
import event from "../images/events.jpeg";
...
export default function Example() {
  ...
  return (
 <div>
     <Tabs value={activeTab} className="relative text-inherit font-serif font-medium ">
      <TabsHeader
      ...
      >
        {data.map(({ label, value }) => (
          ...
          >
            <div className=" absolute top-1/3 z-10 p-4 justify-start text-base font-light">
              {label}
            </div>
          </Tab>
        ))}
      ...
      <TabsBody>
        {data.map(({ value, desc,title, backgroundImage ,Image}) => (
          <TabPanel
            key={value}
            value={value}
          ...
          >
            <div className="text-start absolute bottom-1/2">
              <h2>
                <strong>{title}</strong>
              </h2>
              <br/>
